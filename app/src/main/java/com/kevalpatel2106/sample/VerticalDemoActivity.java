...
import com.kevalpatel2106.rulerpicker.VerticalRulerValuePicker;
...
public class VerticalDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ruler_vertical);
        ...
        nameEt.setText("Sumeet Kumar");

        //Set the height picker
        final TextView heightPickerValueTv = findViewById(R.id.height_value_tv);
        final VerticalRulerValuePicker heightPicker = findViewById(R.id.height_ruler_picker);
